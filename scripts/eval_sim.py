...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="train",
        help="To run experiment in training or eval mode",
    )
    ...
    # Hyperparams
    parser.add_argument(
        "--n_epochs", type=int, default=300, help="Number of epochs"
    )  # Note: models arent't converging with only 300
    parser.add_argument(
    ...
    evaluator = Eval(
        args.train_data,
        args.train_data_star,
        args.test_data,
        lr=0.001,
        hidden_dim=8,  # Increased learning rate
    )
